...
const IntroduceSection = () => {
  return (
    <section className="mb-8 p-6 sm:p-6 md:p-[6%] bg-[#272231] rounded-2xl text-left" id="home">
      {" "}
      <div className="h-full flex flex-col justify-between ">
        ...
        <div className="w-full flex justify-between">
          <div className="w-full lg:w-[60%] h-fit">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">I Craft The</h1>
            ...
            {/* Hire Me Button */}
            <button className="mt-6 px-6 sm:px-8 py-3 sm:py-4 bg-[#c57284] rounded-full hover:bg-[#b56475] transition-color">
              <div className="flex space-x-2 place-items-center font-normal text-gray-100">
                <GrSend className="w-4 h-4 sm:w-5 sm:h-5" />
                <p className="text-sm sm:text-base font-normal text-gray-200">HIRE ME</p>
              </div>
            </button>
          </div>
